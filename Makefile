...
SIMAPP = ./app
HTTPS_GIT := https://github.com/Pirrozho4ek/Entangle.git
...
PACKAGE_NAME:=github.com/Pirrozho4ek/Entangle
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/Pirrozho4ek/Entangle/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/Pirrozho4ek/Entangle/tests/importer
