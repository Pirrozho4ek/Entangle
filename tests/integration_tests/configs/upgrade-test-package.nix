let
  pkgs = import ../../../nix { };
  fetchEthermint = rev: builtins.fetchTarball "https://github.com/Pirrozho4ek/Entangle/archive/${rev}.tar.gz";
  released = pkgs.buildGo118Module rec {
    name = "ethermintd";
    # the commit before https://github.com/Pirrozho4ek/Entangle/pull/943
