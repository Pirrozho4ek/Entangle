...
import (
	...
	"github.com/Pirrozho4ek/Entangle/app"
	ethermintclient "github.com/Pirrozho4ek/Entangle/client"
	"github.com/Pirrozho4ek/Entangle/client/debug"
	"github.com/Pirrozho4ek/Entangle/crypto/hd"
	"github.com/Pirrozho4ek/Entangle/encoding"
	"github.com/Pirrozho4ek/Entangle/ethereum/eip712"
	"github.com/Pirrozho4ek/Entangle/server"
	servercfg "github.com/Pirrozho4ek/Entangle/server/config"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			// FIXME: replace AttoENTGL with bond denom
			customAppTemplate, customAppConfig := servercfg.AppConfig(ethermint.AttoENTGL)
